...
def calculate_preparation_time(emma_noise, emma_preparation_time):
    """
    This function returns time to prepare eye mvt.
    """
    if emma_noise:
        return np.random.gamma(shape=9, scale=emma_preparation_time/9)
    else:
        return emma_preparation_time
